...
public class LoadDatabase {
    ...
    CommandLineRunner initDatabase(ICartaoRepository repository) {
        return args -> {
            ...
            Cartao cartao1 = new Cartao(1L, validade1, "1234567890123456", (short) 123);
            Cartao cartao2 = new Cartao(2L, validade2, "9876543210987654", (short) 456);
            Cartao cartao3 = new Cartao(3L, validade3, "5555666677778888", (short) 789);
